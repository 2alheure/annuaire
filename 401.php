...
<head>
  ...
  */
  ...
  // ! remember to include_once a slight delay in the animation of the key and keyhole
  */
            animation:
...
<body>
    <!-- include_once the svg assets later used in the project -->
    ...
    <!-- include_once in a container a heading, paragraph and svg for the keyhole -->
    <div class="container">
        <h1>401</h1>
    ...
    <!-- outside of the container, to have them absolute positioned in relation to the body, include_once an svg for the key and one for the ghost -->
    <svg class="key">
        <use href="#key" />
    </svg>
...
-->
    ...
    <script>
        ...
        // include_once a timeout with the specified time frame
